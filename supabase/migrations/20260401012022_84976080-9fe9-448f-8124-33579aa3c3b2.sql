...
CREATE POLICY "Admin upload access for email assets" ON storage.objects FOR INSERT TO authenticated WITH CHECK (bucket_id = 'email-assets' AND public.is_admin(auth.uid()));