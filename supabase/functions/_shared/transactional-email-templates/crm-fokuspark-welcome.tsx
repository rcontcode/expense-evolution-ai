...
const FokusparkWelcomeEmail = ({ recipientName, body, ruleName }: Props) => (
      ...
      <Container style={wrapper}>
        ...
        <Container style={card}>
          ...
          <Text style={textStyle}>
            {body || 'Gracias por tu interés en Fokuspark. Estamos listos para ayudarte a potenciar tu enfoque, productividad y bienestar con herramientas diseñadas para ti.'}
          </Text>
          <Section style={ctaSection}>
            <Button style={ctaButton} href="https://fokuspark.com/dashboard">
              Comenzar mi sesión de enfoque
            </Button>
          </Section>
          <Hr style={hr} />
          <Text style={footer}>
...
export const template = {
  component: FokusparkWelcomeEmail,
  subject: (data: Record<string, any>) => data.subject || '¡Bienvenido a Fokuspark! Tu productividad evoluciona hoy',
  displayName: 'Fokuspark Welcome',
  previewData: { recipientName: 'Ana', body: 'Tu perfil de productividad está listo. Descubre cómo Fokuspark puede ayudarte a mantener el enfoque y lograr más cada día.', ruleName: 'Welcome Sequence' },
