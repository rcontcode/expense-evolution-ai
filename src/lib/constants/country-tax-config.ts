...
export const CHILE_CONFIG: CountryConfig = {
  ...
  vatRate: 0.19, // 19% IVA
  regions: [
    { code: 'AP', name: 'XV - Arica y Parinacota' },
    { code: 'TA', name: 'I - Tarapacá' },
    { code: 'AN', name: 'II - Antofagasta' },
    { code: 'AT', name: 'III - Atacama' },
    { code: 'CO', name: 'IV - Coquimbo' },
    { code: 'VS', name: 'V - Valparaíso' },
    { code: 'RM', name: 'RM - Región Metropolitana' },
    { code: 'LI', name: "VI - O'Higgins" },
    { code: 'ML', name: 'VII - Maule' },
    { code: 'NB', name: 'XVI - Ñuble' },
    { code: 'BI', name: 'VIII - Biobío' },
    { code: 'AR', name: 'IX - La Araucanía' },
    { code: 'LR', name: 'XIV - Los Ríos' },
    { code: 'LL', name: 'X - Los Lagos' },
    { code: 'AI', name: 'XI - Aysén' },
    { code: 'MA', name: 'XII - Magallanes' },
  ],
  federalTaxBrackets: [
