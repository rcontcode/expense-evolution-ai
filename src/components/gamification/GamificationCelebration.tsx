 ...
 const CELEBRATION_QUOTES = {
   es: [
     { quote: "¡La disciplina de hoy es la libertad de mañana!", author: "Sabiduría financiera", emoji: "🌟" },
     { quote: "¡Cada pequeño paso te acerca a la grandeza financiera!", author: "Sabiduría financiera", emoji: "🚀" },
     { quote: "¡Los ganadores nunca dejan de aprender!", author: "Sabiduría financiera", emoji: "💎" },
     { quote: "¡La persistencia vence a la resistencia!", author: "Sabiduría financiera", emoji: "🎯" },
     { quote: "¡Estás construyendo hábitos de millonario!", author: "Sabiduría financiera", emoji: "💰" },
     { quote: "¡Tu futuro yo te agradecerá por esto!", author: "Sabiduría financiera", emoji: "👑" },
    { quote: "¡El dinero es un mal amo pero un excelente sirviente!", author: "Sabiduría financiera", emoji: "⚡" },
    { quote: "¡No trabajes por dinero, haz que el dinero trabaje para ti!", author: "Sabiduría financiera", emoji: "🏦" },
    { quote: "¡La riqueza no se mide en dinero, sino en tiempo libre!", author: "Sabiduría financiera", emoji: "⏰" },
   ],
   en: [
     { quote: "Today's discipline is tomorrow's freedom!", author: "Financial wisdom", emoji: "🌟" },
     { quote: "Every small step brings you closer to financial greatness!", author: "Financial wisdom", emoji: "🚀" },
     { quote: "Winners never stop learning!", author: "Financial wisdom", emoji: "💎" },
     { quote: "Persistence beats resistance!", author: "Financial wisdom", emoji: "🎯" },
     { quote: "You're building millionaire habits!", author: "Financial wisdom", emoji: "💰" },
