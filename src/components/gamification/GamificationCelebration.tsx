 ...
 const CELEBRATION_QUOTES = {
   es: [
     ...
     { quote: "¡Estás construyendo hábitos de millonario!", author: "T. Harv Eker", emoji: "💰" },
   ...
   en: [
     ...
     { quote: "You're building millionaire habits!", author: "T. Harv Eker", emoji: "💰" },
 ...
 export function GamificationCelebration({ celebration, onClose }: GamificationCelebrationProps) {
   ...
   useEffect(() => {
     if (celebration) {
       ...
       const colors = ['#8b5cf6', '#ec4899', '#f59e0b', '#10b981', '#3b82f6', '#fbbf24'];
             ...
             <div className="bg-background/95 backdrop-blur-xl rounded-3xl p-8 overflow-hidden">
               ...
               >
                 <div className="relative">
                   ...
                   {/* Main icon container */}
                   <div className={cn('w-28 h-28 rounded-full bg-gradient-to-br p-1 shadow-2xl', config.gradient)}>
               ...
               <AnimatePresence>
                 {showContent && (
                   ...
                   >
                     ...
                     >
                       <h2 className={cn('text-2xl font-black bg-gradient-to-r bg-clip-text text-transparent', config.gradient)}>
                         {celebration.title}
                       </h2>
                     </motion.div>
                     ...
                     <div className="flex items-center justify-center gap-3 pt-2">
                       {celebration.points && (
                         <motion.div
                           ...
                           className={cn('flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r text-white font-bold shadow-lg', config.gradient)}
                         >
                           <Star className="h-5 w-5" />
                           <span className="text-lg">+{celebration.points}</span>
                           <span className="text-sm opacity-80">{text.points}</span>
                         </motion.div>
                       )}
                     ...
                     {randomQuote && (
                       <motion.div
                         ...
                         className="mt-6 p-4 rounded-xl bg-muted/50 border border-muted"
                       >
