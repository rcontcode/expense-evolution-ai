...
const SOCIAL_LINKS = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/company/evofinz',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
  ...
  {
    name: 'Instagram',
    url: 'https://instagram.com/evofinz',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
      ...
      {SOCIAL_LINKS.map((social) => (
        <a
          ...
          className={cn(
            ...
            showLabels && 'flex items-center gap-1.5'
          )}
