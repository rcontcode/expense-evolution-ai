    ...
    <div className="relative flex items-center justify-center py-8">
      <div className="relative">
        ...
        <div className="relative w-[280px] h-[520px] bg-gradient-to-b from-slate-900 to-slate-800 rounded-[3rem] p-2 shadow-2xl border border-slate-700">
          ...
          {/* Screen */}
          <div className="relative w-full h-full bg-gradient-to-b from-indigo-50 to-white rounded-[2.5rem] overflow-hidden">
            {/* Header */}
        ...
        {step === 'complete' && (
          <>
            <motion.div
              ...
              className="absolute -left-32 top-1/4 bg-white rounded-xl px-3 py-2 shadow-xl border border-indigo-200"
            >
              <div className="flex items-center gap-2">
                ...
                <div className="text-xs">
                  <div className="font-bold text-slate-800">{language === 'es' ? '1% mejor' : '1% better'}</div>
                  <div className="text-slate-500">{language === 'es' ? 'cada día' : 'every day'}</div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -right-28 top-1/2 bg-white rounded-xl px-3 py-2 shadow-xl border border-amber-200"
            >
              <div className="flex items-center gap-2">
