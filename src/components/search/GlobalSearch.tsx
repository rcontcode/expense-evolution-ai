...
const DASHBOARD_TOOLS: DashboardToolItem[] = [
  ...
  { label: { es: 'Pagos recurrentes', en: 'Recurring payments' }, emoji: '🔄', path: '/subscriptions', keywords: ['subscriptions', 'suscripciones', 'recurrentes', 'pagos recurrentes'] },
...
const NAVIGATION_ITEMS: NavigationItem[] = [
  ...
  { icon: RefreshCw, label: { es: 'Pagos recurrentes', en: 'Recurring payments' }, path: '/subscriptions', keywords: ['subscription', 'suscripción', 'recurrente'] },
