    ...
    steps: [
      {
        ...
        narration: 'Voy a abrir el formulario de cliente. Primero, hago clic en "Agregar Cliente".',
        autoClick: true,
      },
      {
        highlight: 'add-client-button',
        narration: 'Listo: se abrió el formulario. Ahora completa el nombre del cliente arriba.',
        delay: 5500,
      },
      {
        highlight: 'add-client-button',
        narration: 'Luego agrega email y teléfono (si quieres), para que quede completo.',
        delay: 5500,
      },
      {
        highlight: 'add-client-button',
        narration: 'Opcional: completa país/provincia y dirección. Sirve para kilometraje y orden.',
        delay: 6000,
      },
    ],
  },
