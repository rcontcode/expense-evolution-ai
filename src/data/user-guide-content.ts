...
export const heroContent = {
  ...
  advantages: {
    ...
    items: [
      ...
      { emoji: '📸', es: 'Nunca más pierdas un recibo — captura instantánea inteligente que clasifica por ti', en: 'Never lose a receipt again — smart instant capture that classifies for you' },
      ...
      { emoji: '🤖', es: 'Asistente financiero inteligente que responde preguntas sobre TUS datos', en: 'Smart financial assistant that answers questions about YOUR data' },
      ...
      { emoji: '📊', es: 'Informes inteligentes con comparaciones mes a mes generados automáticamente', en: 'Smart reports with month-to-month comparisons generated automatically' },
...
export const guideSections: GuideSection[] = [
  ...
  },
  {
    ...
    shortDesc: { es: 'Enrutador central de documentos inteligente', en: 'Smart central document router' },
    purpose: {
