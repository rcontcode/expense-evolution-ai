 ...
 const TUTORIAL_STEPS = {
   es: [
     {
       title: '¿Qué es la Aventura Financiera?',
       content: 'Es tu viaje personal hacia la libertad financiera. Cada acción que tomas (registrar gastos, ahorrar, invertir) te da puntos de experiencia (XP) y desbloquea logros.',
       icon: '🗺️',
     },
     {
       title: '¿Cómo gano XP?',
       content: 'Ganas XP de muchas formas: registrando transacciones (+5 XP), manteniendo tu racha diaria (+10 XP), completando metas (+50-500 XP), y desbloqueando logros (+10-500 XP).',
       icon: '⚡',
     },
     {
       title: '¿Qué es la Racha?',
       content: 'Tu racha cuenta los días consecutivos que usas la app. ¡Mientras más larga tu racha, más recompensas! Alcanza hitos como 7 días, 30 días, 100 días...',
       icon: '🔥',
     },
     {
       title: '¿Cómo desbloqueo Logros?',
       content: 'Los logros se desbloquean automáticamente cuando cumples ciertos objetivos: tu primer gasto registrado, $1,000 ahorrados, 30 días de racha, etc.',
       icon: '🏆',
     },
     {
       title: '¿Para qué sirven los Niveles?',
       content: 'Los niveles reflejan tu progreso general. Cada nivel tiene un nombre único y representa tu maestría financiera creciente. ¡Llega al nivel 10 para ser un Cashflow Master!',
       icon: '👑',
     },
   ],
   en: [
     {
       title: 'What is the Financial Adventure?',
       content: "It's your personal journey to financial freedom. Every action you take (logging expenses, saving, investing) gives you experience points (XP) and unlocks achievements.",
       icon: '🗺️',
     },
     {
       title: 'How do I earn XP?',
       content: 'You earn XP in many ways: logging transactions (+5 XP), maintaining your daily streak (+10 XP), completing goals (+50-500 XP), and unlocking achievements (+10-500 XP).',
       icon: '⚡',
     },
     {
       title: 'What is the Streak?',
       content: "Your streak counts consecutive days you use the app. The longer your streak, the more rewards! Reach milestones like 7 days, 30 days, 100 days...",
       icon: '🔥',
     },
     {
       title: 'How do I unlock Achievements?',
       content: 'Achievements unlock automatically when you meet certain goals: your first logged expense, $1,000 saved, 30-day streak, etc.',
       icon: '🏆',
     },
     {
       title: 'What are Levels for?',
       content: 'Levels reflect your overall progress. Each level has a unique name and represents your growing financial mastery. Reach level 10 to become a Cashflow Master!',
       icon: '👑',
     },
   ],
 };
 ...
 export default function FinancialAdventure() {
   ...
   // Random wisdom
   const wisdom = EXPERT_WISDOM[language][Math.floor(Date.now() / 3600000) % EXPERT_WISDOM[language].length];
         ...
         >
           ...
           <div className="relative flex flex-col md:flex-row items-center gap-8">
             ...
             <div className="flex-1 text-center md:text-left">
               <motion.h1
                 className="text-3xl md:text-4xl font-black bg-gradient-to-r from-primary via-accent to-amber-500 bg-clip-text text-transparent"
           ...
           <motion.div
             className="mt-6 p-4 rounded-xl bg-background/80 backdrop-blur border"
             animate={{ opacity: [0.8, 1, 0.8] }}
