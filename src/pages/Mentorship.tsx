...
import { Target, Sparkles, ListChecks, GraduationCap } from 'lucide-react';
      ...
      <div className="container mx-auto p-4 md:p-6 space-y-6">
        ...
        <Tabs defaultValue="library" className="space-y-4">
          <TabsList className="grid grid-cols-4 w-full max-w-xl">
            <TabsTrigger value="library" className="text-xs md:text-sm gap-1">
              <GraduationCap className="h-4 w-4" />
              <span className="hidden sm:inline">{language === 'es' ? 'Biblioteca' : 'Library'}</span>
            </TabsTrigger>
